...
> `hwpx-plugin 1.0.1`, 공개 코어는 `python-hwpx 5.0.2`입니다(released
> 2026-07-31). 문서는 현재 공개 릴리스와 미발행 후보를 항상 구분해 적습니다:
> 이 checkout은 `python-hwpx-automation 6.1.1` 후보 트레인이며, 번들은 재현
> 검증을 위해 `python-hwpx-automation[mcp,oracle]==6.1.1`과
