...
> `python-hwpx-automation 6.4.2`이며 공개 플러그인은 `hwpx-plugin 1.4.0`,
> 공개 코어는 `python-hwpx 5.4.0`입니다(released 2026-08-01). 이 checkout의
> main은 아직 공개되지 않은 후보 `hwpx-plugin 1.4.1` ·
> `python-hwpx 5.5.0`(각주/미주 렌더 계약 수리 트레인)이며, 번들은 재현
> 검증을 위해 `python-hwpx-automation[mcp,oracle]==6.4.2`과
