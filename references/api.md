...
| 릴리스 상태 | 이 checkout의 train 상태 — `unreleased-candidate`: 미발행 후보 (수식 저작 `add_equation` 트레인) | `python-hwpx 5.2.0` · `python-hwpx-automation 6.2.1` · `hwpx-plugin 1.2.0` |
...
미발행 후보 `python-hwpx-automation 6.2.1`의 트랜잭션·서식·그림·비교·생성기·문서 지도 도구 요약이다.
