...
```json
{
  "hwpx": {
    "command": "uvx",
    "args": ["--refresh-package", "python-hwpx-automation", "--refresh-package", "python-hwpx", "--with", "python-hwpx[preview]==5.1.1", "--from", "python-hwpx-automation[mcp,oracle]==6.1.1", "hwpx-automation-mcp"],
    "env": {
