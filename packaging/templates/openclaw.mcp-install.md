...
The source checkout carries the exact `6.0.2 / 7.0.0 / 2.0.0` candidate pins
...
```json
{
  "hwpx": {
    "command": "uvx",
    "args": ["--refresh-package", "python-hwpx-automation", "--refresh-package", "python-hwpx", "--with", "python-hwpx[preview]==6.0.2", "--from", "python-hwpx-automation[mcp,oracle]==7.0.0", "hwpx-automation-mcp"],
    "env": {
