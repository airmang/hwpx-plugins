...
The source checkout carries the exact `5.6.0 / 6.6.4 / 1.6.0` candidate pins
...
```json
{
  "hwpx": {
    "command": "uvx",
    "args": ["--refresh-package", "python-hwpx-automation", "--refresh-package", "python-hwpx", "--with", "python-hwpx[preview]==5.6.0", "--from", "python-hwpx-automation[mcp,oracle]==6.6.4", "hwpx-automation-mcp"],
    "env": {
