...
The source checkout carries the exact `5.2.0 / 6.2.0 / 1.2.0` candidate pins
...
```json
{
  "hwpx": {
    "command": "uvx",
    "args": ["--refresh-package", "python-hwpx-automation", "--refresh-package", "python-hwpx", "--with", "python-hwpx[preview]==5.2.0", "--from", "python-hwpx-automation[mcp,oracle]==6.2.0", "hwpx-automation-mcp"],
    "env": {
