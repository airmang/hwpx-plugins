...
def main() -> int:
    ...
    parser.add_argument("--expected-server-version", default="4.2.0")
    parser.add_argument("--expected-core-version", default="3.3.0")
    parser.add_argument(
        "--server-runtime", "--server-venv", dest="server_runtime", type=Path
    )
    parser.add_argument("--skill-version", default="0.5.0")
