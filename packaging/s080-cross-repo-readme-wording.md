...
> 현재 공개 릴리스는 `python-hwpx 4.1.1`입니다.
...
> 현재 공개 릴리스는 `hwpx-mcp-server 5.0.0`이며 최소 호환 코어는 `python-hwpx 4.1.1`입니다.
> `hwpx-plugin 0.7.1` 설치 번들은 재현성을 위해 MCP를 `==5.0.0`, 코어를 `==4.1.1`으로 고정합니다.
