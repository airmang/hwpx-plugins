...
> `python-hwpx-automation 6.3.0`)입니다. 현재 공개 릴리스는
...
| 소스 후보 트레인 | 이 저장소 main의 아직 공개되지 않은 후보 (네이티브 차트 생성 `add_chart` 트레인) | `python-hwpx 5.3.0` · `python-hwpx-automation 6.3.0` · `hwpx-plugin 1.3.0` |
| 최소 호환 버전 | 1.1 스킬 계약이 지원하는 가장 낮은 조합 | `python-hwpx >= 5.1.0` · `python-hwpx-automation >= 6.1.0` · skill `>= 1.1.0` |
| 플러그인 설치 핀 | 번들이 고정한 정확 버전 | `python-hwpx[preview]==5.3.0` · `python-hwpx-automation[mcp,oracle]==6.3.0` |
