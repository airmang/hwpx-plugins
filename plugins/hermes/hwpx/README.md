...
> `hwpx-plugin 1.6.0`입니다 (released 2026-08-03 — 선언적 편집 계획
> `run_edit_plan` 라우팅·MCP 리소스 구독 트레인).
...
| 구분 | 의미 | 현재 값 |
|---|---|---|
| 완전한 공개 트레인 | 현재 공개 릴리스 — plugin 설치까지 함께 검증한 조합 (released 2026-08-03, 에이전트 계약 표면 트레인) | `python-hwpx 5.6.0` · `python-hwpx-automation 6.6.4` · `hwpx-plugin 1.6.0` |
