...
| 검증 좌표 | 미발행 후보, 로컬 통합 검증 대상 | `python-hwpx 6.4.0` · `python-hwpx-automation 7.1.0` · `hwpx-plugin 2.2.0` |
| 릴리스 상태 | `unreleased-candidate` — 미발행 후보 | `hwpx-plugin 2.2.0` |
...
미발행 후보: `python-hwpx 6.4.0` · `python-hwpx-automation 7.1.0` · `hwpx-plugin 2.2.0`.
현재 공개 릴리스: `python-hwpx 6.3.0` · `python-hwpx-automation 7.0.4` · `hwpx-plugin 2.1.0`.
