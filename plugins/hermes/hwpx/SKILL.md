...
MCP가 없을 때의 local Python(`python-hwpx >= 2.11.0`) 대안과 번들 스크립트는 references 문서에만 있다.
...
| Markdown/HTML/JSON 변환·추출 | `hwpx_to_markdown` · `hwpx_to_html` · `hwpx_extract_json` | [api](references/api.md) |
