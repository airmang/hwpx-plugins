...
| 용어 | 의미 | 현재 값 |
|---|---|---|
| 완전한 공개 트레인 | 마지막으로 plugin 설치까지 함께 검증한 조합 (released 2026-08-04, 엔진 완전성 트레인) | `python-hwpx 6.0.2` · `python-hwpx-automation 7.0.1` · `hwpx-plugin 2.0.0` |
| 릴리스 상태 | 이 checkout의 train 상태 — `released`: 3스택 원격 정본과 실제 설치까지 관찰 완료 | `python-hwpx 6.0.2` · `python-hwpx-automation 7.0.1` · `hwpx-plugin 2.0.0` |
