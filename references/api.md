...
| 용어 | 의미 | 현재 값 |
|---|---|---|
| 완전한 공개 트레인 | 마지막으로 plugin 설치까지 함께 검증한 조합 (released 2026-08-03, 에이전트 계약 표면 트레인) | `python-hwpx 5.6.0` · `python-hwpx-automation 6.6.4` · `hwpx-plugin 1.6.0` |
| 릴리스 상태 | 이 checkout의 train 상태 — `released`: 3스택 원격 정본과 실제 marketplace 설치까지 관찰 완료 | `python-hwpx 5.6.0` · `python-hwpx-automation 6.6.4` · `hwpx-plugin 1.6.0` |
