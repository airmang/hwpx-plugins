...
| 릴리스 상태 | 이 checkout의 train 상태 — `released`: 3스택 원격 정본과 실제 marketplace 설치까지 관찰 완료 | `python-hwpx 5.5.0` · `python-hwpx-automation 6.5.1` · `hwpx-plugin 1.5.0` |
...
이 스킬의 최종 HWPX 산출물 작성에는 최소 호환 버전인 `python-hwpx >= 5.5.0`이 필요하다.
