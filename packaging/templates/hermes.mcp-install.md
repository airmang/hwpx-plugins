...
The `2.0.1 / 7.0.2 / 6.1.0` coordinates below are the current public stack.
...
mcp_servers:
  hwpx:
    command: uvx
    args: ["--refresh-package", "python-hwpx-automation", "--refresh-package", "python-hwpx", "--with", "python-hwpx[preview]==6.1.0", "--from", "python-hwpx-automation[mcp,oracle]==7.0.2", "hwpx-automation-mcp"]
    env:
