...
| 릴리스 상태 | 이 checkout의 train 상태 — `released`: 3스택 원격 정본과 실제 marketplace 설치까지 관찰 완료 | `python-hwpx 5.3.0` · `python-hwpx-automation 6.3.1` · `hwpx-plugin 1.3.0` |
...
공개 릴리스 `python-hwpx-automation 6.3.1`의 트랜잭션·서식·그림·비교·생성기·문서 지도 도구 요약이다.
