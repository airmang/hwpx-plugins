...
The source checkout carries the exact `5.0.1 / 6.0.2 / 1.0.0` candidate pins
...
```json
{
  "hwpx": {
    "command": "uvx",
    "args": ["--refresh-package", "python-hwpx-automation", "--refresh-package", "python-hwpx", "--with", "python-hwpx[preview]==5.0.1", "--from", "python-hwpx-automation[mcp,oracle]==6.0.2", "hwpx-automation-mcp"],
    "env": {
